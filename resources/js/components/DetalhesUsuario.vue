<template>
    <div>
        <h3 class="text-center"><span class="fw-bolder">Detalhes do Usuário: </span> {{ usuario.nome}}</h3>
        <hr/>
        <div class="row">
            <div class="col-md-12">
                <div class="row">
        ...
        <hr/>
        <br/>
        <h4 class="text-center fw-bolder">Formações deste Usuário</h4>
        ...
        <h4 class="text-center fw-bolder">Experiências deste Usuário</h4>
        <table class="table table-bordered">
            <thead>
                <tr>
                <th>ID</th>
